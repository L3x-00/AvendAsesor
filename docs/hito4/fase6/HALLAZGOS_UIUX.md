...
| H-08 | 🟡 | Vista de módulo | No existe vista informativa del módulo (título+descripción) ni "Formatos para descargar" (guía §5, §9). | 2/3 | PARCIAL: título de módulo agregado en F1; descripción y formatos pendientes. |
